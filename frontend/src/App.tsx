...
import QuickLinksSection, { type QuickLinkData } from './components/QuickLinksSection';
...
function App() {
  ...
  const [quickLinkPrefill, setQuickLinkPrefill] = useState<Partial<BookingData> | undefined>(
    undefined,
  );
            ...
            <div className="flex flex-col justify-center space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-lg text-gray-200 md:text-xl">
                  Experience comfortable and reliable cab service from Nashik to Pune. Professional
                  drivers, transparent pricing, and door-to-door convenience.
                </p>
              </div>
