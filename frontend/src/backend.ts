...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "hyundaiXcent" in value ? CarModel.hyundaiXcent : "alto" in value ? CarModel.alto : "bmw5Series" in value ? CarModel.bmw5Series : "marutiCiaz" in value ? CarModel.marutiCiaz : "innovaCrysta" in value ? CarModel.innovaCrysta : "swiftDzire" in value ? CarModel.swiftDzire : "ertiga" in value ? CarModel.ertiga : "audiA6" in value ? CarModel.audiA6 : "scorpio" in value ? CarModel.scorpio : "mercedesEClass" in value ? CarModel.mercedesEClass : "swift" in value ? CarModel.swift : "wagonR" in value ? CarModel.wagonR : "hondaAmaze" in value ? CarModel.hondaAmaze : value;
}
...
function to_candid_variant_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CarModel): {
    ...
    return value == CarModel.hyundaiXcent ? {
        hyundaiXcent: null
    } : value == CarModel.alto ? {
        alto: null
